...
| --- | --- |
| Origin/frontier structural generation | [World Generation](world-generation.md) |
| Generator reproduction identity | [Generator Identity](generator-identity.md) |
| Frozen revision-1 algorithm | [Frontier Generator Revision 1](generator-revision-1.md) |
| Profile schema and mutable configuration semantics | [Tuning Profiles](tuning-profiles.md) |
| Physical ownership and resource lifecycle | [Systems and Resources](systems-and-resources.md) |
| Energy production, seasons, priority, and retention | [Energy and Seasons](energy-and-seasons.md) |
| Population identity, Habitat support, and generation | [Population and Habitats](population-and-habitats.md) |
